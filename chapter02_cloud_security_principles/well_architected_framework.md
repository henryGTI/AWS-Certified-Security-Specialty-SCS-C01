...
클라우드에서 안전하고, 효율적이며, 비용 효과적으로 워크로드를 설계·운영할 수 있도록  
5가지 핵심 Pillar(기둥)로 구성된 아키텍처 가이드라인입니다.
...
## 2. 실제 AWS Well-Architected Tool 사용 경험

### 사용 방법
1. AWS 콘솔에서 **Well-Architected Tool** 검색 및 실행
2. 워크로드(프로젝트) 생성
3. 각 Pillar별로 질문(예: 보안 정책, 백업 전략 등)에 답변
4. 리스크(위험) 및 개선 권장사항 자동 제안
5. 개선 계획(Improvement Plan) 다운로드 및 적용
...
- [AWS Well-Architected Framework 공식 문서(한글)](https://docs.aws.amazon.com/ko_kr/wellarchitected/latest/framework/welcome.html)
- [AWS Well-Architected Tool 소개](https://aws.amazon.com/ko/well-architected-tool/)
